...
Part of my [Linux setup](https://github.com/se-kami/setup); maintained separately here.
...
The related [desktop helpers](https://github.com/se-kami/setup/tree/main/scripts/desktop) include `updatebar` and
